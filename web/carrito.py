class Cart:
    ...
    def __init__(self,request):
        ...
        self.session = request.session  # obtiene la session del navegador
    ...
    def add(self,producto,cantidad):
        ...
        self.save()  # pasa mi variable a la variable de session, guarda cambios en el carrito de compras
